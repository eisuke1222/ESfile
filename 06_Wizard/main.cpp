...
#define WINDOW_NAME		"Wizard"			// ウインドウのキャプション名
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	//HCURSOR hCursor = ::LoadCursor(hInstance, MAKEINTRESOURCE(IDI_ICON1));
...
// スクリーンショット
//=============================================================================
bool ScreenShot(char *cBmpName, bool bUpdate)
{
	HDC     hdc;
	HWND    hwndDesk;
	RECT    rc;
	...
	{
		if (bUpdate == true)
			wsprintf(cName, "data\\TEXTURE\\ScreenShot\\%s.bmp", cBmpName);				// 名前作成
		else
