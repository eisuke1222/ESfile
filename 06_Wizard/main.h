...
#include "imgui_impl_dx9.h"				// ImGui_directx9
#include "imgui_impl_win32.h"			// ImGui_win32
...
// プロトタイプ宣言
//*****************************************************************************
bool ScreenShot(char *cBmpName, bool bUpdate = false);		// スクリーンショット
