...
#define MAX_TEXTURE_MESHFIELD		(4)										// テクスチャの最大数
#define MESHFIELD_TEXTURE_NAME1		"data\\TEXTURE\\field101.jpg"			// 読み込むテクスチャファイル1
#define MESHFIELD_TEXTURE_NAME2		"data\\TEXTURE\\field102.jpg"			// 読み込むテクスチャファイル2
#define MESHFIELD_TEXTURE_NAME3		"data\\TEXTURE\\field103.jpg"			// 読み込むテクスチャファイル3
#define MESHFIELD_TEXTURE_NAME4		"data\\TEXTURE\\field104.jpg"			// 読み込むテクスチャファイル4
...
// グローバル変数
//*************************************************************************************************************************
LPDIRECT3DTEXTURE9				g_pTextureMeshField[MAX_TEXTURE_MESHFIELD] = {};	// テクスチャへのポインタ
...
{
	// テクスチャの破棄
	for (int nCntTex = 0; nCntTex < MAX_TEXTURE_MESHFIELD; nCntTex++)
	{
...
void DrawMeshField(void)
{
	...
	for (nCntMeshField = 0; nCntMeshField < g_MaxMeshField; nCntMeshField++)
	{
		if (g_MeshField[nCntMeshField].bUse == true)
		{
			...
			// テクスチャ設定
			if (g_MeshField[nCntMeshField].nTexNum == MAX_TEXTURE_MESHFIELD)
			{
			...
			// フィールドの描画
			pDevice->DrawIndexedPrimitive(D3DPT_TRIANGLESTRIP, nNumIdx, 0, g_MeshField[nCntMeshField].MaxVtx + nNumVtx, 0, g_MeshField[nCntMeshField].MaxPolygon);
		}
